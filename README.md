...
As it is a personal project. I will not be giving the prompt's for training or fine-tuning the model. But all the prompts (around 100) were custom and not publically available. 
